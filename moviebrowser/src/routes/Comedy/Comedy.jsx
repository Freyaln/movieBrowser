...
const Comedy = () => {
    ...
    useEffect(() => {
        ...
        db.get('/discover/movie?api_key=4d1a84bd8e2f776949378aaece646762&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=2&with_genres=35', { cache: 'reload' })
            .then((res) => {
                setComedy2(res.data.results);
                setPending(true);
            })
            .catch((error) => {
                console.log(error)
